...
export function validateAuthState(obj: any): obj is AuthState {
  return (
    ...
    (obj.authMode === undefined || ['interactive', 'servicePrincipal', 'manualToken'].includes(obj.authMode)) &&
    (obj.tokenExpiresAt === undefined || typeof obj.tokenExpiresAt === 'string') &&
    ...
    (obj.tokenScopes === undefined || (
      ...
      (obj.tokenScopes.dataPipelineReadWrite === undefined || typeof obj.tokenScopes.dataPipelineReadWrite === 'boolean') &&
      typeof obj.tokenScopes.gatewayReadWrite === 'boolean' &&
      typeof obj.tokenScopes.itemReadWrite === 'boolean' &&
      (obj.tokenScopes.workspaceReadWrite === undefined || typeof obj.tokenScopes.workspaceReadWrite === 'boolean') &&
